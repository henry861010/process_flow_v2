...
```text
python -m process_flow_api.cad_export_worker <format> <input-json> <output-file>
```
...
| `apps/api/src/process_flow_api/cad_export_worker.py` | Isolated Python worker entry point. |
| `apps/api/src/process_flow_api/cad_exporter.py` | CadQuery/OCP geometry conversion and GLB/STEP export implementation. |
