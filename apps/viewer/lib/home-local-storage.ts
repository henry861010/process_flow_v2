...
export const PROCESS_STEP_TEMPLATE_SEED: ProcessStepTemplate[] = [
  ...
  },
  {
    ...
    program: "layer/rdl",
    description:
      "Builds RDL dielectric layers with odd-layer downward via features and even-layer circuit features over the current process footprint.",
    owner: "integration.platform",
    fieldDefinitions: [
      {
        id: "main_geometry",
      ...
      },
      {
        ...
        name: "layers",
        description:
          "RDL layer stack. Odd-numbered layers create downward via features after dielectric deposit; even-numbered layers create circuit features before dielectric deposit.",
        scope: "processParameter",
  ...
  },
  {
    ...
    program: "saw/saw",
    description:
      "Recursively cuts the main geometry to a retained XY rectangle and updates the process footprint to that rectangle.",
    owner: "integration.platform",
    fieldDefinitions: [
      {
        id: "main_geometry",
        name: "main_geometry",
        description:
          "Complete geometry state consumed by saw. The operation keeps only geometry inside the retained XY rectangle.",
        scope: "inputState",
        valueType: "geometryRef",
        controlType: null,
        selectionMode: null,
      ...
      },
      {
        id: "bottomLeftX",
        name: "bottomLeftX",
        description: "Retained rectangle lower-left X coordinate.",
        scope: "processParameter",
        valueType: "float",
        controlType: "number",
        selectionMode: null,
      ...
      },
      {
        id: "bottomLeftY",
        name: "bottomLeftY",
        description: "Retained rectangle lower-left Y coordinate.",
        scope: "processParameter",
        valueType: "float",
        controlType: "number",
        selectionMode: null,
      ...
      },
      {
        id: "topRightX",
        name: "topRightX",
        description: "Retained rectangle upper-right X coordinate.",
        scope: "processParameter",
        valueType: "float",
        controlType: "number",
        selectionMode: null,
      ...
      },
      {
        id: "topRightY",
        name: "topRightY",
        description: "Retained rectangle upper-right Y coordinate.",
        scope: "processParameter",
        valueType: "float",
        controlType: "number",
        selectionMode: null,
