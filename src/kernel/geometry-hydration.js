 ...
 */
export function geometryStructureToProcessGeometryState(payload, options = {}) {
 ...
 */
export function processGeometryStateToGeometryStructure(value) {
  if (
    value instanceof ProcessGeometryState ||
    (value?.toGeometryStructure &&
      typeof value.toGeometryStructure === "function")
  ) {
